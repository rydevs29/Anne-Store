...
import Link from "next/link"; // Ini baris yang ditambahkan untuk mengaktifkan klik

// JANGAN DIHAPUS: Ini data dummy sementara
    ...
    <main className="min-h-screen bg-soft-pink text-dark-gray font-sans">
      ...
      <header className="bg-white/80 backdrop-blur-md shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex justify-between items-center">
          ...
          <nav>
            {/* INI YANG BERUBAH: Mengganti <button> menjadi <Link> yang mengarah ke /checkout */}
            <Link 
              href="/checkout" 
